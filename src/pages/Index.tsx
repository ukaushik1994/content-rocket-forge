  ...
  return <ContentStrategyProvider>
      ...
      <div className="min-h-screen flex flex-col bg-background overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <motion.div className="absolute top-[10%] left-[15%] w-[800px] h-[800px] rounded-full bg-gradient-to-r from-neon-purple/15 via-neon-blue/10 to-transparent blur-[120px]" animate={{
            x: [0, 50, 0],
            y: [0, -30, 0],
            scale: [1, 1.1, 1],
            opacity: [0.7, 1, 0.7]
          ...
          <motion.div className="absolute top-[40%] right-[10%] w-[600px] h-[600px] rounded-full bg-gradient-to-l from-neon-pink/12 via-neon-purple/8 to-transparent blur-[100px]" animate={{
            x: [0, -40, 0],
            y: [0, 40, 0],
            scale: [1, 0.9, 1],
            opacity: [0.6, 0.9, 0.6]
          ...
          <motion.div className="absolute bottom-[20%] left-[25%] w-[500px] h-[500px] rounded-full bg-gradient-to-tr from-neon-blue/10 via-cyan-400/8 to-transparent blur-[80px]" animate={{
            x: [0, 30, 0],
            y: [0, -25, 0],
            scale: [1, 1.15, 1],
            opacity: [0.5, 0.8, 0.5]
