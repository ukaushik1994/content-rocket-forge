...
import { Sparkles, GitBranch, BarChart3, Zap, Plus } from 'lucide-react';
import { ContentStrategyProvider, useContentStrategy } from '@/contexts/ContentStrategyContext';
import { ContentPipeline } from '@/components/research/content-strategy/pipeline/ContentPipeline';

const PipelineInner: React.FC = () => {
  ...
  return (
    <section aria-labelledby="pipeline-heading">
      <h2 id="pipeline-heading" className="sr-only">Content Pipeline Module</h2>
...
const PipelinePage: React.FC = () => {
  const canonicalUrl = typeof window !== 'undefined'
    ? `${window.location.origin}/research/pipeline`
    : '/research/pipeline';
  ...
  return (
    <ContentStrategyProvider>
      <div className="min-h-screen bg-background relative overflow-hidden">
        <Helmet>
          <title>Content Pipeline — Track Production Stages</title>
          <meta name="description" content="Track content production stages from ideation to published with clear progress and priorities." />
          ...
          >
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-sm font-medium">Production Flow</span>
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
                Manage stages, priorities, and progress across your content operations.
              </p>

              {/* Quick stats */}
              <div className="flex justify-center gap-6">
                {[{Icon: GitBranch, label: 'Stages'}, {Icon: Plus, label: 'Add Item'}, {Icon: Zap, label: 'Real-time'}].map(({Icon, label}) => (
