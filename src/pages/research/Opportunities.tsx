...
const OpportunitiesPage: React.FC = () => {
  const canonicalUrl = typeof window !== 'undefined' ? `${window.location.origin}/research/opportunities` : '/research/opportunities';
  return <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <main className="flex-1 container py-10 z-10 relative max-w-7xl mx-auto">
        ...
        <motion.section className="text-center mb-10 relative" initial={{
        opacity: 0,
        y: 30
      }} animate={{
        opacity: 1,
        ...
        duration: 0.6
          ...
          <div className="relative">
            <motion.div className="inline-flex items-center gap-3 px-6 py-3 bg-background/60 backdrop-blur-xl rounded-full border border-border/50 mb-6" whileHover={{
            scale: 1.03
          }} transition={{
            type: 'spring',
            stiffness: 300
            ...
            <motion.h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-foreground via-primary to-blue-500 bg-clip-text text-transparent">Advanced Opportunities</motion.h1>
            ...
            <div className="flex justify-center gap-6">
              ...
              Icon,
              label
            }, idx) => <motion.div key={label} className="text-center" whileHover={{
              scale: 1.05
            }} transition={{
              type: 'spring',
              stiffness: 300
