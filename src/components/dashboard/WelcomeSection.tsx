...
export const WelcomeSection: React.FC<WelcomeSectionProps> = ({ setFeedbackOpen, navigate }) => {
  return (
    <div className="relative overflow-hidden rounded-xl p-6 md:p-8 glass-panel shadow-lg border border-white/10 backdrop-blur-xl">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
        ...
        >
          ...
          >
            ...
            >
              <Button 
                className="bg-gradient-to-r from-neon-purple to-neon-blue hover:from-neon-blue hover:to-neon-purple transition-all duration-300 hover:shadow-neon group relative overflow-hidden" 
        ...
        <motion.div 
          className="w-full max-w-[220px] flex items-center justify-center" 
          ...
          <div className="relative">
            <motion.div 
              ...
              animate={{ 
                ...
                rotate: [0, 10, 0],
                background: [
                  "radial-gradient(circle, rgba(155,135,245,0.2), rgba(51,195,240,0.2), rgba(217,70,239,0.2))",
                  "radial-gradient(circle, rgba(51,195,240,0.2), rgba(217,70,239,0.2), rgba(155,135,245,0.2))",
                  "radial-gradient(circle, rgba(217,70,239,0.2), rgba(155,135,245,0.2), rgba(51,195,240,0.2))"
                ]
              }}
              transition={{
                duration: 8,
            ...
            >
              <div className="relative">
                <motion.div 
                  className="absolute -inset-4 rounded-full bg-primary/20 opacity-70"
                  animate={{ 
                    scale: [1, 1.2, 1],
                    opacity: [0.5, 0.7, 0.5]
                  }}
