  ...
  return <div className="w-full space-y-8">
      ...
      <div className="space-y-3 animate-fade-in">
        ...
        <div className="relative h-2 w-full bg-white/5 rounded-full overflow-hidden border border-white/10">
          <div className="absolute top-0 left-0 h-full bg-gradient-to-r from-neon-purple to-neon-blue transition-all duration-500 ease-out" style={{
      ...
      {/* Step Navigation */}
      <div className="w-full overflow-x-auto scrollbar-none animate-scale-in">
      ...
      {/* Step Content */}
      <div className="rounded-xl border border-white/10 p-8 shadow-lg backdrop-blur-xl bg-gray-950 animate-slide-up">
