...
export const FinalReviewHeader: React.FC<FinalReviewHeaderProps> = ({
  ...
  return (
    <div className="bg-gradient-to-r from-purple-950/20 via-indigo-950/10 to-blue-950/20 backdrop-blur-md border border-purple-500/30 rounded-xl p-6 shadow-xl">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-6">
          {seoScore !== undefined && (
            <div className="flex flex-col items-center">
              ...
              <div className="relative">
                <motion.div 
                  className={`h-16 w-16 rounded-full bg-gradient-to-r ${getScoreColor(seoScore)} flex items-center justify-center shadow-lg`}
          ...
          <div className="flex flex-col items-center">
            ...
            <motion.div 
              className={`h-16 w-16 rounded-full bg-gradient-to-r ${getProgressColor(completionPercentage)} flex items-center justify-center shadow-lg`}
              initial={{ scale: 0.8, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
