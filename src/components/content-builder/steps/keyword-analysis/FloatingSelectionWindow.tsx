            ...
            stiffness: 200
                ...
                <div className="p-4 border-b border-white/10 bg-gradient-to-r from-black/70 to-black/50 backdrop-blur-sm">
                  ...
                  delay: 0.2
                      ...
                      <Button variant="ghost" size="sm" onClick={() => setIsExpanded(false)} className="hover:bg-white/10 text-white/80 hover:text-white group transition-all duration-300">
                ...
                <div className="p-6 max-h-80 overflow-y-auto custom-scrollbar">
                  ...
                  delay: 0.1
                      ...
                      <div className="flex items-center gap-2 mb-4">
                        <motion.div className="h-1 w-8 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full" animate={{
                      scaleX: [1, 1.2, 1]
                    }} transition={{
                      duration: 3,
                      repeat: Infinity
                      ...
                      <motion.div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-xl border border-white/20 shadow-lg overflow-hidden card-3d" whileHover={{
                    scale: 1.02
                  }} transition={{
                    type: "spring",
                    stiffness: 300
                        ...
                        <div className="relative p-1">
                          <div className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-lg border border-blue-500/20">
                            <SelectedKeywords keywords={selectedKeywords} onRemoveKeyword={onRemoveKeyword} />
                          </div>
                        </div>
                      </motion.div>
                    </motion.section>
                  ...
                  delay: 0.2
                      ...
                      <div className="flex items-center gap-2 mb-4">
                        <motion.div className="h-1 w-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full" animate={{
                      scaleX: [1, 1.2, 1]
                    }} transition={{
                      duration: 3,
                      repeat: Infinity,
                      ...
                      <motion.div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-xl border border-white/20 shadow-lg card-3d" whileHover={{
                    scale: 1.02
                  }} transition={{
                    type: "spring",
                    stiffness: 300
                        ...
                        <div className="relative">
                          <SelectionSummaryCard serpSelections={serpSelections} onOpenSelectionManager={onOpenSelectionManager} />
                        </div>
                      </motion.div>
                    </motion.section>
                  </div>
