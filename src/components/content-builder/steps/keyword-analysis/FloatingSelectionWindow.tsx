  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-28 left-1/2 transform -translate-x-1/2 z-50 floating-particles"
      >
        <div className="relative">
          ...
          <div className="relative bg-black/80 backdrop-blur-2xl border border-white/10 rounded-xl shadow-2xl max-w-4xl card-glass">
