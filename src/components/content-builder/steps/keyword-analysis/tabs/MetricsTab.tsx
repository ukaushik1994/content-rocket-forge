...
export function MetricsTab({
  ...
  return <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        ...
        y: -5
            ...
            <Card className="relative overflow-hidden bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-xl border border-white/10 hover:border-white/20 transition-all duration-300 h-full">
              ...
              <div className="absolute bottom-4 left-4 w-1 h-1 bg-white/30 rounded-full animate-pulse" style={{
            animationDelay: '1s'
          }} />
              ...
              <CardContent className="p-6 relative z-10">
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <Progress value={metric.progress} className="h-2 bg-gray-800 border border-white/10" />
      ...
      {serpData.volumeMetadata && <motion.div initial={{
      opacity: 0,
      y: 30
    }} animate={{
      opacity: 1,
      ...
      duration: 0.6
          ...
          <Card className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-xl border border-white/10 overflow-hidden">
            ...
            <CardContent className="relative z-10">
              ...
              updated: serpData.volumeMetadata.lastUpdated ? new Date(serpData.volumeMetadata.lastUpdated).toLocaleDateString() : 'Unknown'
            }).map(([key, value], index) => <motion.div key={key} initial={{
              opacity: 0,
              scale: 0.8
            }} animate={{
              opacity: 1,
      ...
      {serpData.topResults && serpData.topResults.length > 0 && <motion.div initial={{
      opacity: 0,
      y: 30
    }} animate={{
      opacity: 1,
          ...
          <Card className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-xl border border-white/10 overflow-hidden">
            ...
            <CardContent className="relative z-10">
              ...
              <div className="space-y-4">
                {serpData.topResults.slice(0, 3).map((result, index) => <motion.div key={index} initial={{
              opacity: 0,
              x: -20
            }} animate={{
              opacity: 1,
