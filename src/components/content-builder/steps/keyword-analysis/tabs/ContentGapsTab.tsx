    ...
    return (
      ...
      >
        <div className="relative mb-6">
          ...
          <div className="relative p-6 bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-full backdrop-blur-sm border border-white/10">
        ...
        <p className="text-gray-400 max-w-md">
          No content opportunities were identified in the competitive analysis. This could mean strong market coverage.
        </p>
      </motion.div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-3">
          <div className="p-2 bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-lg backdrop-blur-sm border border-white/10">
        ...
        <Badge className="bg-gradient-to-r from-orange-500/20 to-red-500/20 text-orange-300 border-orange-500/30 font-mono">
            ...
            return (
              ...
              >
                <Card className={`relative overflow-hidden transition-all duration-300 ${
                  ...
                  {selected && (
                    <>
                      <div className="absolute top-3 right-3 w-1 h-1 bg-orange-400 rounded-full animate-pulse" />
                      <div className="absolute bottom-3 left-3 w-1 h-1 bg-red-400 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
                    </>
                  )}
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1 space-y-3">
                        <div className="flex items-center gap-3">
                          <div className={`p-2 rounded-lg backdrop-blur-sm border transition-all duration-300 ${
                            selected 
                              ...
                              : 'bg-gradient-to-r from-orange-500/20 to-red-500/20 border-white/20'
                          }`}>
                        ...
                        {gapDescription && (
                          ...
                          >
                            {gapDescription.length > 150 ? 
                              `${gapDescription.substring(0, 150)}...` : 
                              gapDescription
                            }
                          </motion.div>
                        )}
                        ...
                        {gapRecommendation && (
                          <motion.div
                            initial={{ opacity: 0, height: 0 }}
                            animate={{ opacity: 1, height: 'auto' }}
                            className="flex items-start gap-2 p-3 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-lg border border-blue-500/20"
                          >
                            <Lightbulb className="h-4 w-4 text-blue-400 mt-0.5 flex-shrink-0" />
                            <p className="text-sm text-blue-300">
                              {gapRecommendation.length > 200 ? 
                                `${gapRecommendation.substring(0, 200)}...` : 
                                gapRecommendation
                              }
                            </p>
                          </motion.div>
