              ...
              <CardContent className="p-4">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    {gapDescription && <p className="text-sm text-muted-foreground mb-2">
                        {gapDescription}
                      </p>}
                    {gapRecommendation && <div className="flex items-start gap-2 p-2 bg-blue-50 dark:bg-blue-900/20 rounded-md">
                  ...
                  <Button variant={selected ? "default" : "outline"} size="sm" onClick={() => onToggleSelection('contentGap', gapContent)} className="ml-4">
                    {selected ? <>
