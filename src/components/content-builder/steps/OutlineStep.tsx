...
import { ContentOutlineSection, SerpSelection } from '@/contexts/ContentBuilderContext';
...
export const OutlineStep = () => {
  ...
  const { outline, serpData, mainKeyword, serpSelections, additionalInstructions } = state;
