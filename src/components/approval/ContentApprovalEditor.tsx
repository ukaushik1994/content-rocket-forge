          ...
          <CardContent className="p-0 flex-1 flex flex-col min-h-0">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col min-h-0">
              ...
              <TabsContent value="preview" className="mt-0 focus-visible:outline-none focus-visible:ring-0 flex-1 min-h-0 flex flex-col">
                <div className="flex-1 min-h-0 px-6 pb-6 pt-0 overflow-y-scroll prose prose-slate dark:prose-invert prose-headings:font-bold prose-h1:text-2xl prose-h2:text-xl prose-h3:text-lg max-w-none text-white/90 scrollbar-thin scrollbar-thumb-black scrollbar-track-transparent">
