        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1 }}
              transition={{ delay: 0.5 + index * 0.12, type: "spring", stiffness: 150, damping: 12 }}
            ...
            >
              ...
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 0.7 + index * 0.12, ease: "easeInOut" }}
          ...
          <div key={index} className="space-y-1">
            <div className="flex items-center justify-between text-xs">
              ...
              <motion.span
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 1.4 + index * 0.18, ease: "easeInOut" }}
            ...
            <div className="h-1.5 bg-background/50 rounded-full overflow-hidden">
              <motion.div
                ...
                transition={{ duration: 1.3, delay: 1.4 + index * 0.18, ease: "easeInOut" }}
              />
            </div>
          </div>
        ))}
