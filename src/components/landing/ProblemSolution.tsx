        ...
        >
          ...
          <GlassCard className="p-8 max-w-5xl mx-auto relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex justify-center items-center gap-2 mb-8 overflow-x-auto pb-4">
                {['Create Content', 'Publish & Track', 'Analyze Results', 'AI Learns', 'Improve'].map((step, index) => (
                  <React.Fragment key={index}>
                    ...
                    >
                      <div className={`px-2 sm:px-3 py-1.5 sm:py-2 rounded-full bg-gradient-to-r ${
                        index === 3 
                      ...
                      {index === 3 && (
                        <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 z-20">
                          <div className="bg-gradient-to-r from-neon-pink to-neon-orange text-white text-[10px] font-bold px-2 py-0.5 rounded-full animate-pulse whitespace-nowrap shadow-lg border border-white/30 backdrop-blur-sm">
