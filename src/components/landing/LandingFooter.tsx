...
export const LandingFooter = () => {
  ...
  const socialLinks = [
    { icon: Twitter, href: 'https://twitter.com/creaiter', label: 'Twitter' },
    { icon: Github, href: 'https://github.com/creaiter', label: 'GitHub' },
    { icon: Linkedin, href: 'https://linkedin.com/company/creaiter', label: 'LinkedIn' },
    { icon: Mail, href: 'mailto:hello@creaiter.com', label: 'Email' }
  ];
      ...
      <Container>
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-lg bg-background/50 border border-border/50 focus:border-primary focus:outline-none"
              />
        ...
        >
          <div className="flex items-center gap-2 text-muted-foreground mb-4 md:mb-0">
            <span>© 2024 CreAiter. Made with</span>
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((social, index) => (
              <motion.a
                ...
                viewport={{ once: true }}
                className="w-10 h-10 rounded-full bg-gradient-to-r from-primary/20 to-neon-blue/20 border border-primary/30 flex items-center justify-center hover:from-primary/30 hover:to-neon-blue/30 hover:shadow-neon transition-all duration-300"
        ...
        <div className="absolute bottom-20 right-1/3 w-1 h-1 bg-neon-blue rounded-full animate-pulse opacity-80" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 right-10 w-1.5 h-1.5 bg-neon-pink rounded-full animate-pulse opacity-70" style={{ animationDelay: '2s' }}></div>
      </Container>
    </footer>
  );
};