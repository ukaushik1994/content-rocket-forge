...
import { FileText, BarChart3, Puzzle, CheckCircle, ChevronDown, Search, Target, Megaphone, Mail, Users, Layers, GitBranch, Zap, Share2, Activity, Send } from 'lucide-react';
