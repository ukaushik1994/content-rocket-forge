...
import { Home, FileText, BarChart3, Puzzle, CheckCircle, Repeat } from 'lucide-react';
...
export default function NavItems() {
  ...
  return <div className="flex flex-row gap-1">
      ...
      <NavItem to="/drafts" icon={<FileText className="h-4 w-4" />} label="Drafts" active={location.pathname === '/drafts'} />
      <NavItem to="/content-builder" icon={<Puzzle className="h-4 w-4" />} label="Builder" active={location.pathname === '/content-builder'} />
      <NavItem to="/content-repurposing" icon={<Repeat className="h-4 w-4" />} label="Repurpose" active={location.pathname === '/content-repurposing'} />
