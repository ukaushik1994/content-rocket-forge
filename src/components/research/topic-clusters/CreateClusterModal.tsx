...
export function CreateClusterModal({ isOpen, onClose, onSuccess }: CreateClusterModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const cluster = await topicClusterService.createCluster(formData);
      toast.success(`Topic cluster "${cluster.name}" created successfully!`);
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setFormData(prev => ({ ...prev, mainKeyword: e.target.value }))}
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  placeholder="Add content themes..."
                  className="flex-1"
                />
                <Button 
                  type="button" 
