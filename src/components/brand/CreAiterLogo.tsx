      ...
      <div className="relative">
        ...
        <div className={`${sizeClasses[size]} rounded-full bg-gradient-to-br from-background/80 to-background/60 backdrop-blur-sm flex items-center justify-center border border-white/10 relative`}>
          <svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M16.5 6.5C14.8 4.8 12.5 4 10 4C7.5 4 5.2 4.8 3.5 6.5C1.8 8.2 1 10.5 1 13C1 15.5 1.8 17.8 3.5 19.5C5.2 21.2 7.5 22 10 22C12.5 22 14.8 21.2 16.5 19.5" stroke="url(#spectrumGradient)" strokeWidth="2.5" strokeLinecap="round" />
            ...
            <path d="M14 8.5C12.8 7.3 11.2 6.5 9.5 6.5C7.8 6.5 6.2 7.3 5 8.5" stroke="url(#neuralGradient1)" strokeWidth="1.2" strokeLinecap="round" opacity="0.5" />
            <path d="M13.5 17C12.5 18 11.2 18.5 9.5 18.5C8 18.5 6.5 18 5.5 17" stroke="url(#neuralGradient2)" strokeWidth="1.2" strokeLinecap="round" opacity="0.5" />
