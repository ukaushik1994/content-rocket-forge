...
export type ContentBuilderAction =
  ...
  | { type: 'SET_OUTLINE_AUTO_GENERATED'; payload: boolean }
  ...
  | { type: 'UPDATE_SEO_SCORE'; payload: number }
  | { type: 'ADD_SEO_IMPROVEMENT'; payload: any }
  | { type: 'RESET_SERP_SELECTIONS' }
  | { type: 'SET_CONTENT_LEAD_IN'; payload: string };
