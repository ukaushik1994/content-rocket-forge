...
/**
 * Enhanced Offering type definitions
 * (Renamed from enhanced-solution-types.ts)
 */
...
export interface EnhancedOfferingResource {
  id: string;
  title: string;
  url: string;
...
export interface EnhancedOffering {
  id: string;
  name: string;
  description: string;
  features: string[];
...
export type EnhancedSolutionResource = EnhancedOfferingResource;
export type SolutionMetrics = OfferingMetrics;
export type EnhancedSolution = EnhancedOffering;
