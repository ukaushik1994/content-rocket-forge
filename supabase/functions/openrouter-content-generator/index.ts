    ...
    const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are an expert content writer for CreAiter. Create high-quality, engaging content that follows SEO best practices and aligns with the user\'s brand voice.'
          },
          {
            role: 'user',
            content: prompt
